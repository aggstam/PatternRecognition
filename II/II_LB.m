...
fprintf('LB Correct Classication Ratio median(10-Fold Validation, multi-layer neural network) for Train sample: %0.4f.\n',TrainCorrectClassificationRatio);
TestCorrectClassificationRatio = TestCorrectClassificationRatioSum / K;
fprintf('LB Correct Classication Ratio median(10-Fold Validation, multi-layer neural network) for Test sample: %0.4f.\n',TestCorrectClassificationRatio);
