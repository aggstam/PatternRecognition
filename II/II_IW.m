% --------------------------------------------------------------------------
%
% This script creates a multilayer neural network for IW data,
% and predicts the match results, validating using K-fold validation.
%
% --------------------------------------------------------------------------

function [TrainCorrectClassificationRatio, TestCorrectClassificationRatio] = II_IW(conn)
...
fprintf('IW Correct Classication Ratio median(10-Fold Validation, multi-layer neural network) for Train sample: %0.4f.\n',TrainCorrectClassificationRatio);
TestCorrectClassificationRatio = TestCorrectClassificationRatioSum / K;
fprintf('IW Correct Classication Ratio median(10-Fold Validation, multi-layer neural network) for Test sample: %0.4f.\n',TestCorrectClassificationRatio);
