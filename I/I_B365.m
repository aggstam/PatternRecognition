...
fprintf('B365 Correct Classication Ratio median(10-Fold Validation, linear neural network) for Train sample: %0.4f.\n',TrainCorrectClassificationRatio);
TestCorrectClassificationRatio = TestCorrectClassificationRatioSum / K;
fprintf('B365 Correct Classication Ratio median(10-Fold Validation, linear neural network) for Test sample: %0.4f.\n',TestCorrectClassificationRatio);
