% --------------------------------------------------------------------------
%
% This script creates a simple neural network for BW data,
% and predicts the match results, validating using K-fold validation.
%
% --------------------------------------------------------------------------

function [TrainCorrectClassificationRatio, TestCorrectClassificationRatio] = I_BW(conn)
...
fprintf('BW Correct Classication Ratio median(10-Fold Validation, linear neural network) for Train sample: %0.4f.\n',TrainCorrectClassificationRatio);
TestCorrectClassificationRatio = TestCorrectClassificationRatioSum / K;
fprintf('BW Correct Classication Ratio median(10-Fold Validation, linear neural network) for Test sample: %0.4f.\n',TestCorrectClassificationRatio);
